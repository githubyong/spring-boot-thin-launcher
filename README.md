...
A "thin" jar launcher for java apps. Version 1.0.24.GE-SNAPSHOT is in Maven Central, snapshots are in https://repo.spring.io/libs-snapshot. See https://github.com/spring-projects/spring-boot/issues/1813 for more discussion and ideas.
...
plugins {
	...
	id 'java'
	id 'maven'
	id 'org.springframework.boot.experimental.thin-launcher' version '1.0.24.GE-SNAPSHOT'
}
